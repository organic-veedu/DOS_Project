...
public class Description_1 {
    ...
    static void findAvgTime(int processes[], int n, int burstTimes[], int quantum, int arrivalTimes[]) {
        int wt[] = new int[n], tat[] = new int[n], ct[] = new int[n], rt[] = new int[n];
    ...
    static void compareAlgorithmsEfficiency(double avgWaitingTimeRR,
        ...
        if (avgWaitingTimeRR < avgWaitingTimeFCFS) {
            System.out.println("Round Robin (RR) algorithm resultsin the minimum average waiting time = "+avgWaitingTimeRR);
